...
``Note : les focntionnalitées sont ici décrite en fonction des droits de l'utilisateur connecté, sachant qu'un chef d'agence possède les droits qu'un guichetier.``
