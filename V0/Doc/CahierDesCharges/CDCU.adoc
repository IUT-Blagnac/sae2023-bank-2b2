...
Dans la version existante (V0), un guichetier peut modifier les informations client, créer un nouveau client, consulter un compte et débiter un compte. Un chef d'agence peut rendre inactif un client.
