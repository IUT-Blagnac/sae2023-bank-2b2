...
image::RessourcesAdoc/img/OperationDebit.png[Alt Page de connexion, 50%]
...
image::RessourcesAdoc/img/OperationTypeDebit.png[Alt Page de connexion, 50%]

Ensuite, il vous faut entrer un montant valide, c'est à dire, que le solde du compte ne dépasse pas le dévouvert maximum autorisé et puis cliquer sur effectuer le virement.

image::RessourcesAdoc/img/OperationDebitEffectue.png[Alt Page de connexion, 50%]
