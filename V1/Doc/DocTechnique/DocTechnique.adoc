...
Les tests sont plus pertinent s'ils sont executer tous ensemble mais ils peuvent et sont réalisé de façon àa ce qu'il puisse être executer de façon indépendant.
