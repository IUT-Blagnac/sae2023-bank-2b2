...
De plus, une fonctionnalité d'une modification d'un compte courant visant à modifier le découvert maximum autorisé va permettre une gestion maximum des comptes des clients.
